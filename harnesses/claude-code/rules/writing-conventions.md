---
description: 'Prose conventions for Markdown and authored text: punctuation (em-dashes, colons, semicolons), claims and evidence (concessive pivots, verbless scale enumerations, colon-as-evidence, unquantified intensifiers), sentence construction (adverbs, cleft frames, commas, pronoun agreement), acronyms, heading case, US spelling, filler, banned vocabulary. Apply when writing or editing Markdown or prose.'
paths:
- '**/*.md'
- '**/*.mdx'
- '**/*.rst'
