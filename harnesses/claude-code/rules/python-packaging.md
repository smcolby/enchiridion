---
description: 'Python project structure and dependency management: preserve the repository''s declared environment manager, manifests, lockfiles, package layout, and gate commands. Apply when creating or modifying Python project configuration, dependency files, environment definitions, or scaffolding.'
paths:
- '**/pyproject.toml'
- '**/requirements*.txt'
- '**/requirements*.in'
