...
* Check the code against every directive of the cheminformatics rule (listed in the `rules` skill index), plus any other active rules. Each violated directive is a finding.
